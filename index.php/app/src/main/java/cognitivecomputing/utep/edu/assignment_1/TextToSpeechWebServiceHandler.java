package cognitivecomputing.utep.edu.assignment_1;
...
public class TextToSpeechWebServiceHandler {
    ...
    private final String USERNAME = "17151170-9acf-48fc-90eb-90a6adaee97f";
    private final String PASSWORD = "COM06dKsEk2f";
